...
I did not expect it becomes so big (fine it may looks simple on UI) in the begining. However as I was developing it, more and more idea comes to me and I cannot say no to implement them. It is in this procedure I have deeper understanding on the Vue design.
...
Secret: to login, you enter any user name equal and just enter the same content as the password, then you are in!
...
5. Vuex to store the common state info like user's profile and and many other modules.
6. Webpack for front end codes compiling and packaging.